...
export const API_ENDPOINTS = {
  ...
  submissions: {
    ...
    detail: (id: string) => `${API_BASE_URL}/submissions/${id}/`,
    adminList: `${API_BASE_URL}/submissions/admin/`,
    adminDetail: (id: string) => `${API_BASE_URL}/submissions/admin/${id}/`,
    adminApprove: (id: string) => `${API_BASE_URL}/submissions/admin/${id}/approve/`,
    adminReject: (id: string) => `${API_BASE_URL}/submissions/admin/${id}/reject/`,
    adminCorrection: (id: string) => `${API_BASE_URL}/submissions/admin/${id}/correction/`,
    adminConvert: (id: string) => `${API_BASE_URL}/submissions/admin/${id}/convert-to-asset/`,
  },
  thirdParty: {
    submissions: `${API_BASE_URL}/third-party/submissions/`,
    submissionDetail: (id: string) => `${API_BASE_URL}/third-party/submissions/${id}/`,
    verify: `${API_BASE_URL}/third-party/verify`,
    addAsset: `${API_BASE_URL}/third-party/add-asset`,
  },
  admin: {
    submissions: `${API_BASE_URL}/admin/submissions/`,
    submissionDetail: (id: string) => `${API_BASE_URL}/admin/submissions/${id}/`,
    submissionApprove: (id: string) => `${API_BASE_URL}/admin/submissions/${id}/approve/`,
    submissionReject: (id: string) => `${API_BASE_URL}/admin/submissions/${id}/reject/`,
    submissionCorrection: (id: string) => `${API_BASE_URL}/admin/submissions/${id}/correction/`,
    submissionConvert: (id: string) => `${API_BASE_URL}/admin/submissions/${id}/convert-to-asset/`,
